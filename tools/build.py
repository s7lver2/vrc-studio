...
;  Compilar con:  ISCC.exe vrc-studio-setup.iss
; ──────────────────────────────────────────────────────────────────
...
Name: "startmenuicon"; Description: "Crear grupo en el &menú Inicio";  GroupDescription: "Accesos directos:"

[Dirs]
Name: "{app}"
Name: "{app}\data"
Name: "{localappdata}\VRC Studio";          Flags: uninsalwaysuninstall
Name: "{localappdata}\VRC Studio\config";   Flags: uninsalwaysuninstall

[Files]
; ── Ejecutable y dependencias en runtime ────────────────────────────
...
[Icons]
Name: "{group}\VRC Studio";           Filename: "{app}\vrc-studio.exe"; Tasks: startmenuicon
Name: "{group}\Desinstalar VRC Studio"; Filename: "{uninstallexe}";      Tasks: startmenuicon
